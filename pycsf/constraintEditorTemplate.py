...
class Ui_constraintEditor(object):
    def setupUi(self, constraintEditor):
        ...
        self.gridLayout = QtWidgets.QGridLayout(constraintEditor)
        self.gridLayout.setObjectName(_fromUtf8("gridLayout"))
        self.constraintTree = QtWidgets.QTreeWidget(constraintEditor)
        self.constraintTree.setObjectName(_fromUtf8("constraintTree"))
        item_0 = QtWidgets.QTreeWidgetItem(self.constraintTree)
